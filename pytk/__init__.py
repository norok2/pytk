...
def _app_dirs(
    ...
    import appdirs
    dirs = dict((
        ('config', appdirs.user_config_dir(name, developer, version)),
        ('cache', appdirs.user_cache_dir(name, developer, version)),
        ('data', appdirs.user_data_dir(name, developer, version)),
        ('log', appdirs.user_log_dir(name, developer, version)),
    ))
    return dirs
